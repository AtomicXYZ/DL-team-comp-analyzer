...
from dl_team_comp_analyzer.match_parser import build_match_view, match_view_to_dict


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fetch Deadlock matches into data/v2/matches.jsonl.")
